...
There is an [DMI extension for aseprite](https://github.com/spacestation13/aseprite-dmi) that only works on windows. You can run it by using lutris with relativly little pain, especially if byond is already set up.
## Setup aseprite
...
5. Thats it, aseprite ins't as picky as byond'
...
5. If any alerts pop up check give full trust to this script. and then finally apply.